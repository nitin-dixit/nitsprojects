<%@ Page Title="" Language="C#" MasterPageFile="~/MainAdminMaster.master" AutoEventWireup="true" CodeFile="tblCompFaculty.aspx.cs" Inherits="tblCompFaculty" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="">
            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="#">tblCompFaculty</a></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCS %>" SelectCommand="SELECT * FROM [tblCompFaculty]" FilterExpression="Fname LIKE '{0}%'" DeleteCommand="DELETE FROM [tblCompFaculty] WHERE [Fid] = @Fid" InsertCommand="INSERT INTO [tblCompFaculty] ([Fname], [Email]) VALUES (@Fname, @Email)" UpdateCommand="UPDATE [tblCompFaculty] SET [Fname] = @Fname, [Email] = @Email WHERE [Fid] = @Fid">
            <DeleteParameters>
        ...
        <div class="row">
            <div class="container-fluid">
                <div class="card">
                    <h4 class="card-header"><i class="fa fa-table"></i>tblCompFaculty</h4>
                    <div class="card-body">
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" ShowFooter="True" AllowSorting="True" AutoGenerateColumns="False" CssClass="Grid container-fluid text-center" DataKeyNames="Fid" DataSourceID="SqlDataSource1" OnPreRender="GridView1_PreRender">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Fid" InsertVisible="False" SortExpression="Fid">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("Fid") %>'></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
