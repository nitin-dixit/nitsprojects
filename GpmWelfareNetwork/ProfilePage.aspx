<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true" CodeFile="ProfilePage.aspx.cs" Inherits="ProfilePage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container btn-outline-info">
        <asp:panel ID="imagepanel"  CssClass="alert-light " runat="server">
                 <div class="btn-group col-md-7 col-sm-4 ">
          <asp:FileUpload ID="btnupload" runat="server" CssClass="btn btnupload alert-info btn-outline-primary" Text=" Add featured Photos" />
          
       
            <div class="btn  searchbtn btn-info btn-outline-info" > <asp:LinkButton ID="LinkButton1" ForeColor="Black" OnClick="upload_click" Text="Upload Feature Photos" runat="server"></asp:LinkButton></div>
            ...
            <div class="container">
                <div class="row">
    <asp:Panel ID="uploadedimage" CssClass="  col-lg-12 " runat="server" >
