<%@ Page Title="" Language="C#" MasterPageFile="~/MainAdminMaster.master" AutoEventWireup="true" CodeFile="CompFeedback.aspx.cs" Inherits="CompFeedback" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="">
         <div class="">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Comp</a></li>
            </ol>
        </nav>
             </div>
         </div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCS %>" DeleteCommand="DELETE FROM [tblCompFeedback] WHERE [Fid] = @Fid" InsertCommand="INSERT INTO [tblCompFeedback] ([Sname], [SenrollNo], [FacultyName], [Q1], [Q2], [Q3], [Q4], [Q5], [FeedbackText]) VALUES (@Sname, @SenrollNo, @FacultyName, @Q1, @Q2, @Q3, @Q4, @Q5, @FeedbackText)" SelectCommand="SELECT * FROM [tblCompFeedback]" UpdateCommand="UPDATE [tblCompFeedback] SET [Sname] = @Sname, [SenrollNo] = @SenrollNo, [FacultyName] = @FacultyName, [Q1] = @Q1, [Q2] = @Q2, [Q3] = @Q3, [Q4] = @Q4, [Q5] = @Q5, [FeedbackText] = @FeedbackText WHERE [Fid] = @Fid" FilterExpression="FacultyName LIKE '{0}%'">
        <DeleteParameters>
    ...
    <div class="row">
        <div class="container-fluid">
            <div class="card">
                <h4 class="card-header"><i class="fa fa-wpforms"></i> Comp Feedback</h4>
                <div class="card-body">
