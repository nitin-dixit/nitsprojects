<%@ Page Title="" Language="C#" MasterPageFile="~/MainAdminMaster.master" AutoEventWireup="true" CodeFile="tblElecFaculty.aspx.cs" Inherits="tblElecFaculty" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="">
            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="#">tblElecFaculty</a></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCS %>" SelectCommand="SELECT * FROM [tblElecFaculty]" FilterExpression="Fname LIKE '{0}%'" DeleteCommand="DELETE FROM [tblElecFaculty] WHERE [Fid] = @Fid" InsertCommand="INSERT INTO [tblElecFaculty] ([Fname], [Email]) VALUES (@Fname, @Email)" UpdateCommand="UPDATE [tblElecFaculty] SET [Fname] = @Fname, [Email] = @Email WHERE [Fid] = @Fid">
            <DeleteParameters>
        ...
        <div class="row">
            <div class="container-fluid">
                <div class="card">
                    <h4 class="card-header"><i class="fa fa-table"></i> tblElecFaculty</h4>
                    <div class="card-body">
