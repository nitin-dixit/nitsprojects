<%@ Page Title="" Language="C#" MasterPageFile="~/MainAdminMaster.master" AutoEventWireup="true" CodeFile="tblITFaculty.aspx.cs" Inherits="tblITFaculty" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="">
            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="#">tblITFaculty</a></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCS %>" SelectCommand="SELECT * FROM [tblITFaculty]" FilterExpression="Fname LIKE '{0}%'" DeleteCommand="DELETE FROM [tblITFaculty] WHERE [Fid] = @Fid" InsertCommand="INSERT INTO [tblITFaculty] ([Fname], [Email]) VALUES (@Fname, @Email)" UpdateCommand="UPDATE [tblITFaculty] SET [Fname] = @Fname, [Email] = @Email WHERE [Fid] = @Fid">
            <DeleteParameters>
        ...
        <div class="row">
            <div class="container-fluid">
                <div class="card">
                    <h4 class="card-header"><i class="fa fa-table"></i>tblITFaculty</h4>
                    <div class="card-body">
