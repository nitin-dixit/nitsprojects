<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true" CodeFile="MyLostedItem.aspx.cs" Inherits="MyLostedItem" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <blockquote class="blockquote text-center">
                <p class="mb-0" style="margin-top: 4em;"<strong>My Complaints.... </strong> <i class="fa  fa-quote-right " aria-hidden="true"></i></p>
